...
describe('Test suite: renderOrderSummary', () => {
  ...
  it('displays cart', () => {
    ...
    expect(
      document.querySelector(`.js-product-name-${productId1}`).innerText).toEqual(productName1);

    expect(
      document.querySelector(`.js-product-name-${productId2}`).innerText).toEqual(productName2);
  ...
  it('updates the delivery option', () => {
    ...
    // Product1 delivery option-3 = $999 plus product2 delivery option-2 = $499. This expects the total of both to be $14.98
