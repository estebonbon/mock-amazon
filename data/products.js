...
// CODE IS FOR CHECKOUT.JS and CHECKOUT.HTML
export let products = [];
...
// This is the old method of the code, I hvae to keep it because this version of the code contains a callback, func, the makes renderProducts grid on the amazon project activate. CODE IS FOR AMAZON.JS & AMAZON.HTML
export function loadProducts(func) {
  ...
  xhr.addEventListener('load', () => {
    ...
    // The first line is the command we want it to execute, second line executes.
